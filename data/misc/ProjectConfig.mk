...
CUSTOM_BUILD_VERNO = CY-KD7-H6211-F
...
CUSTOM_HAL_IMGSENSOR = s5k3p9sx_mipi_raw gc8034_mipi_raw gc2375h_mipi_raw gc02m1b_mipi_raw gc2375hmain3_mipi_raw gc02m1_mipi_raw gc6153_serial_yuv pblcs5k3p9sx_mipi_raw pblcgc8034_mipi_raw pblcgc2375h_mipi_raw pblcgc02m1b_mipi_raw pblcgc2375hmain3_mipi_raw pblcgc02m1_mipi_raw pblcgc6153_serial_yuv
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3p9sx_17201613 gc8034_17201572 gc2375h_17201624 gc02m1b_17201634 gc2375h_17201622 gc02m1_17201633 gc6153_17201581
...
#ITD:modify by camera driver team end
#BSP: modify KDQAEA-3 by tao.lan for 20191022 start
CUSTOM_HAL_MSENSORLIB =
#BSP: modify KDQAEA-3 by tao.lan for 20191022 end
...
#BSP: modify KDQAEA-3 by tao.lan for 20191022 end
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3p9sx_mipi_raw gc8034_mipi_raw gc2375h_mipi_raw gc02m1b_mipi_raw gc2375hmain3_mipi_raw gc02m1_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
#BSP: modify BLSLEPUB-1550 by tao.lan for 20191028 start
CUSTOM_KERNEL_SIGNIFICANT_MOTION_SENSOR = no
#BSP: modify BLSLEPUB-1550 by tao.lan for 20191028 end
...
#TSD: modify BLSLEPUB-265 by baoxin.he 20191017 start
CUSTOM_MODEM=kd7_h6211_f1
#TSD: modify BLSLEPUB-265 by baoxin.he 20191017 end
...
LCM_WIDTH = 720
#BSP: modify P1 porting CDQHLEYSSS-3 by baofu.zhang 20190923 end
#BSP: modify P1 porting BLSLEPUB-3511 by meng.zhang 20191121 start
TRAN_PROXIMITY_NO_DIM_SUPPORT = yes
#BSP: modify P1 porting BLSLEPUB-3511 by meng.zhang 20191121 end
...
#ITD:add cam 3pty function by shoufeng.zhao 20191022 start
MTK_CAM_HDR_SUPPORT = no
#ITD:add cam 3pty function by shoufeng.zhao 20191022 end
...
#SDD: modify KDQHHLEYL-11 by ke.zhang 20191104 start
MTK_CTA_SET = no
#SDD: modify KDQHHLEYL-11 by ke.zhang 20191104 end
MTK_CTA_SUPPORT = no
MTK_CTM_SUPPORT = no
...
MTK_IRTX_SUPPORT = no
#BSP: modify for BLSLEPUB-3273 by ming.chen 20191113 start
MTK_JEITA_STANDARD_SUPPORT = yes
#BSP: modify for BLSLEPUB-3273 by ming.chen 20191113 end
MTK_K64_SUPPORT=yes
...
#SDD: modify KDQHHLEYL-11 by ke.zhang 20191111 start
MTK_LOG_CUSTOMER_SUPPORT = yes
#SDD: modify KDQHHLEYL-11 by ke.zhang 20191111 end
...
#BSP: add custom macro by wanghanfeng 20190922 start
CUSTOM_TRAN_PROJECT=tran_kd7
CUSTOM_TRAN_BOM=tran_kd7_f1
MTK_BUILD_VERNO=KD7-H6211FQRSTU-Q-GL-201014V335
TRAN_FINGERPRINT_BUILD_VERNO=FQRSTU-GL-201014V335
...
#ITD: add SKIN by zhoumw 20191106 start
...
ifeq ($(strip $(TRAN_FT_MEM_TRACE_SUPPORT)), yes)
  ...
  PRODUCT_SYSTEM_DEFAULT_PROPERTIES += ro.vendor.proinfo.memtrace.support.emmctest=yes
